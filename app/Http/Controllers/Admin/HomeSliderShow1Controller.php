...
class HomeSliderShow1Controller extends CrudController
{
...
//        $this->crud->denyAccess(['create']);
    ...
    {
        $this->crud->setModel("App\Models\HomeSliderShow1Model");
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/slider_home_show1');
        $this->crud->setEntityNameStrings('Ảnh trình diễn trang chủ 1', 'Ảnh trình diễn trang chủ 1');
        ...
        */
        ...
        $this->crud->addField([    // Image
            'name' => 'image',
            'label' => 'Ảnh đại diện (Vui lòng upload ảnh với kích thước 1920 x 820 pixel)',
            'type' => 'browse',
        ]);
    ...
    public function store(Request $request)
    {
        ...
        $this->setSaveAction();
        $prods = \App\Models\HomeSliderShow1Model::get();
        $content = view::make('home.home_slider_show_1', compact('prods'))->render();
        file_put_contents(resource_path().'/views/cache/home_slider_show_1.blade.php', $content);

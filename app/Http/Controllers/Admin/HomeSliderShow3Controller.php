...
class HomeSliderShow3Controller extends CrudController
{
    ...
    {
        $this->crud->setModel("App\Models\HomeSliderShow3Model");
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/slider_home_show3');
        $this->crud->setEntityNameStrings('Ảnh trình diễn trang chủ 3', 'Ảnh trình diễn trang chủ 3');
        ...
        */
        ...
        $this->crud->addField([    // Image
            'name' => 'image',
            'label' => 'Ảnh đại diện (Vui lòng upload ảnh với kích thước 952 x 416 pixel)',
            'type' => 'browse',
        ]);
...
//        file_put_contents(resource_path().'/views/cache/menu.blade.php', $content);
    ...
    public function update(Request $request)
    {
        ...
        // save the redirect choice for next time
        $this->setSaveAction();
        $prods = \App\Models\HomeSliderShow3Model::get();
        $content = view::make('home.home_slider_show_3', compact('prods'))->render();
        file_put_contents(resource_path().'/views/cache/home_slider_show_3.blade.php', $content);
